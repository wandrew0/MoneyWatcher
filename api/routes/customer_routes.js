...
router.route("/").get(customer_controller.get_all_customers);

router.route("/signup").post(customer_controller.create_customer);

router.route("/login").post(customer_controller.login);

router
    .route("/bank")
    .post(
        customer_controller.protect,
